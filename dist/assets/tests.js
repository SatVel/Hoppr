...
define('hoppr-ui/tests/components/hoppr-grid.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/hoppr-grid.js should pass jshint.\ncomponents/hoppr-grid.js: line 37, col 5, \'height\' is defined but never used.\ncomponents/hoppr-grid.js: line 38, col 5, \'width\' is defined but never used.\ncomponents/hoppr-grid.js: line 39, col 5, \'gridOptions\' is defined but never used.\ncomponents/hoppr-grid.js: line 4, col 7, \'keys\' is defined but never used.\ncomponents/hoppr-grid.js: line 7, col 3, \'get\' is defined but never used.\ncomponents/hoppr-grid.js: line 8, col 3, \'set\' is defined but never used.\ncomponents/hoppr-grid.js: line 9, col 3, \'getWithDefault\' is defined but never used.\ncomponents/hoppr-grid.js: line 10, col 3, \'setProperties\' is defined but never used.\ncomponents/hoppr-grid.js: line 11, col 3, \'getProperties\' is defined but never used.\ncomponents/hoppr-grid.js: line 12, col 3, \'computed\' is defined but never used.\ncomponents/hoppr-grid.js: line 13, col 3, \'observer\' is defined but never used.\ncomponents/hoppr-grid.js: line 14, col 3, \'isNone\' is defined but never used.\ncomponents/hoppr-grid.js: line 16, col 3, \'on\' is defined but never used.\ncomponents/hoppr-grid.js: line 17, col 3, \'defineProperty\' is defined but never used.\ncomponents/hoppr-grid.js: line 18, col 3, \'compare\' is defined but never used.\ncomponents/hoppr-grid.js: line 19, col 3, \'typeOf\' is defined but never used.\ncomponents/hoppr-grid.js: line 20, col 3, \'run\' is defined but never used.\ncomponents/hoppr-grid.js: line 22, col 3, \'assert\' is defined but never used.\ncomponents/hoppr-grid.js: line 23, col 11, \'S\' is defined but never used.\ncomponents/hoppr-grid.js: line 24, col 11, \'O\' is defined but never used.\ncomponents/hoppr-grid.js: line 25, col 6, \'jQ\' is defined but never used.\n\n21 errors');
  });
});
...
define('hoppr-ui/tests/types/grid.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'types/grid.js should pass jshint.');
  });
});
